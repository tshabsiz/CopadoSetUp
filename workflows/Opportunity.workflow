...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>peter.mokebe@absa1.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        <fullName>Pravate_Opportunity_alert_to_been_when_the_pravate_opp_is_closed</fullName>
        <ccEmails>AbCapPrivateSideAdv@barclayscapital.com</ccEmails>
        <description>Pravate Opportunity alert to been when the pravate opp is closed.</description>
        <protected>false</protected>
        <recipients>
        ...
        <senderType>CurrentUser</senderType>
        <template>Worklfow_Email_Templates/Private_Opportunity_Closure_email</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <ccEmails>louiseste@absa.co.za</ccEmails>
...
Campaign.Name =&apos;Money Market Deposit Campaign&apos;,  ISCHANGED(Accountable_Banker__c)
    ...
    <rules>
        ...
        <actions>
            <name>Pravate_Opportunity_alert_to_been_when_the_pravate_opp_is_closed</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <criteriaItems>
